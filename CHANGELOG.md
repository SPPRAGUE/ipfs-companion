...
## [4.0.0](https://github.com/SPPRAGUE/ipfs-companion/compare/v3.1.0...v4.0.0) (2026-07-20)
...
* *.localhost subdomain gateway support with http proxy ([5cc81be](https://github.com/SPPRAGUE/ipfs-companion/commit/5cc81befb8943070a96d76d8ed80324ea9427db4))
...
* add automated translation sync workflow ([#1346](https://github.com/SPPRAGUE/ipfs-companion/issues/1346)) ([137c0d4](https://github.com/SPPRAGUE/ipfs-companion/commit/137c0d4c57ee926802875845ee7ce138544bc150))
...
* explain broken ipfs:// addresses ([#1380](https://github.com/SPPRAGUE/ipfs-companion/issues/1380)) ([bb861e8](https://github.com/SPPRAGUE/ipfs-companion/commit/bb861e810073c6106543e1d0a71bc546011ad9fd)), closes [#1133](https://github.com/SPPRAGUE/ipfs-companion/issues/1133)
* **i18:** add Turkish locale ([ece3e0b](https://github.com/SPPRAGUE/ipfs-companion/commit/ece3e0bef8d2b5f92259b314d973b5f7dbbb5b1d))
* **i18n:** :arrow_down: Pulling Translations ([#1286](https://github.com/SPPRAGUE/ipfs-companion/issues/1286)) ([33a8f4c](https://github.com/SPPRAGUE/ipfs-companion/commit/33a8f4cace4895c79bb978eb3b0302e96ed890cb))
...
* make public gateways optional for sharing ([#1371](https://github.com/SPPRAGUE/ipfs-companion/issues/1371)) ([5558e5f](https://github.com/SPPRAGUE/ipfs-companion/commit/5558e5fcee314f38c56bb285fb4d90800190ae89))
* Moving from ipfs-http-client -&gt; kubo-rpc-client ([#1124](https://github.com/SPPRAGUE/ipfs-companion/issues/1124)) ([d439a97](https://github.com/SPPRAGUE/ipfs-companion/commit/d439a974fd899d9c2f834c70ca41cccf64ffd1fa))
* **mv3:** :heavy_plus_sign: Adding hash function to generate predictable ids. ([5873528](https://github.com/SPPRAGUE/ipfs-companion/commit/5873528ebcdeff1ce778e41aedc2db793b6279c6))
* **MV3:** MV3 Implementation Collector Branch ([#1182](https://github.com/SPPRAGUE/ipfs-companion/issues/1182)) ([5873528](https://github.com/SPPRAGUE/ipfs-companion/commit/5873528ebcdeff1ce778e41aedc2db793b6279c6))
...
* show full rpc backend version ([#1294](https://github.com/SPPRAGUE/ipfs-companion/issues/1294)) ([9f852ef](https://github.com/SPPRAGUE/ipfs-companion/commit/9f852ef8a2fcfa9881cd8a019b3280c0c2a5c023))
...
* TCP client in Brave ([#754](https://github.com/SPPRAGUE/ipfs-companion/issues/754)) ([8f7eda4](https://github.com/SPPRAGUE/ipfs-companion/commit/8f7eda417808227bd0a4348999645186b635a3ae))
...
* upload folders in quick upload ([#1381](https://github.com/SPPRAGUE/ipfs-companion/issues/1381)) ([7025593](https://github.com/SPPRAGUE/ipfs-companion/commit/7025593f5d7915b9e27a7f0270a4c46ad4a8e57d))
...
* :bug: waiting for test to finish for longer ([#1136](https://github.com/SPPRAGUE/ipfs-companion/issues/1136)) ([382cc2e](https://github.com/SPPRAGUE/ipfs-companion/commit/382cc2e03f8f491ac02c868b958c3f5eac18a989))
...
* add transifex environment to workflow job ([19883c6](https://github.com/SPPRAGUE/ipfs-companion/commit/19883c65332812a0da2c6c16cf24976c410295a4))
...
* **brave:** not updating tab to the new redirect url in some cases. ([#1285](https://github.com/SPPRAGUE/ipfs-companion/issues/1285)) ([4097e2d](https://github.com/SPPRAGUE/ipfs-companion/commit/4097e2d88d956400d2143adfbc916ac63587488d))
...
* decode content paths with decodeURI ([1acf899](https://github.com/SPPRAGUE/ipfs-companion/commit/1acf89954a2ff08b4205ae35309353c520ea9575))
...
* disable window.ipfs until JS API is updated ([597fd6f](https://github.com/SPPRAGUE/ipfs-companion/commit/597fd6f0c3e90100393d8114f3ed6fc37baccb9f))
...
* **firefox:** :wrench: Min FF Version ([#1290](https://github.com/SPPRAGUE/ipfs-companion/issues/1290)) ([09492a4](https://github.com/SPPRAGUE/ipfs-companion/commit/09492a4ff8b2df69f25ce2fea4f35882a5d9ae2f))
...
* improve transifex sync workflow reliability and ux ([b2b67b4](https://github.com/SPPRAGUE/ipfs-companion/commit/b2b67b4526d223bca2823c4f6f113e1257669872))
...
* manifest v3 offline status detection ([#1340](https://github.com/SPPRAGUE/ipfs-companion/issues/1340)) ([0816d9c](https://github.com/SPPRAGUE/ipfs-companion/commit/0816d9c3e6d0a8ef37a4f0b5005d301dc203dfb5))
* minimize the amount of CSS assets ([#882](https://github.com/SPPRAGUE/ipfs-companion/issues/882)) ([1e6f42e](https://github.com/SPPRAGUE/ipfs-companion/commit/1e6f42ed794a9c869406ad48438244ffa7d8cce6))
...
* **options:** :wastebasket: Fix target URLs. ([#1280](https://github.com/SPPRAGUE/ipfs-companion/issues/1280)) ([dcc10f0](https://github.com/SPPRAGUE/ipfs-companion/commit/dcc10f0c995fc8cfa97094f491e10a771d6addef))
...
* prevent version span from affecting icon layout ([#1345](https://github.com/SPPRAGUE/ipfs-companion/issues/1345)) ([da87de6](https://github.com/SPPRAGUE/ipfs-companion/commit/da87de6c3b401e4a4b8c7108731214a957b43336))
...
* **release-automation:** :alien: Tags are not being created. ([#1287](https://github.com/SPPRAGUE/ipfs-companion/issues/1287)) ([3229c2a](https://github.com/SPPRAGUE/ipfs-companion/commit/3229c2a2be30a3cc440fd47c02474ff8a36eeb16))
...
* **release-automation:** :wrench: removing default command and skippi github release ([#1291](https://github.com/SPPRAGUE/ipfs-companion/issues/1291)) ([cd081de](https://github.com/SPPRAGUE/ipfs-companion/commit/cd081de9ba6fba7adbc1e3390b4376a2e9b9a988))
* **release-automation:** :wrench: removing default command and skipping github release. ([cd081de](https://github.com/SPPRAGUE/ipfs-companion/commit/cd081de9ba6fba7adbc1e3390b4376a2e9b9a988))
* **release-automation:** :wrench: Skip Labels ([#1293](https://github.com/SPPRAGUE/ipfs-companion/issues/1293)) ([e9191ba](https://github.com/SPPRAGUE/ipfs-companion/commit/e9191ba47d99eb811c2c897b29faa4e81c28b3a6))
...
* remove countly ([#1327](https://github.com/SPPRAGUE/ipfs-companion/issues/1327)) ([70790a3](https://github.com/SPPRAGUE/ipfs-companion/commit/70790a3ebef563d330c1a8f76b0b6feba9b992c2))
* remove disabled telemetry code ([#1343](https://github.com/SPPRAGUE/ipfs-companion/issues/1343)) ([a707d43](https://github.com/SPPRAGUE/ipfs-companion/commit/a707d43394ffc2d3651311cded900c590a5cc8ea))
...
* replace IPFS API with Kubo RPC ([#1164](https://github.com/SPPRAGUE/ipfs-companion/issues/1164)) ([1a6495d](https://github.com/SPPRAGUE/ipfs-companion/commit/1a6495de5e1017b533cac4cbf869577f64541770))
...
* skip DNSLink resolution when offline, deduplicate inflights ([#1339](https://github.com/SPPRAGUE/ipfs-companion/issues/1339)) ([f805293](https://github.com/SPPRAGUE/ipfs-companion/commit/f8052934480ad9e13c657dbc2adb1e5bdc81d058))
...
* **telemetry:** :arrow_down: Reduce event syncs ([#1296](https://github.com/SPPRAGUE/ipfs-companion/issues/1296)) ([6326cdb](https://github.com/SPPRAGUE/ipfs-companion/commit/6326cdb7db91ea98e3c061ff49c1b48ccaeb2724))
* **test:** 🚧 Making e2e Tests work again. ([#1308](https://github.com/SPPRAGUE/ipfs-companion/issues/1308)) ([6f17967](https://github.com/SPPRAGUE/ipfs-companion/commit/6f179676fa8651d46d232b217bd5903d376678d8))
...
* update actions/cache from v3.2.4 to v4 ([34083ea](https://github.com/SPPRAGUE/ipfs-companion/commit/34083ea5a516327fcdf186ac892e5afca1253c4b))
...
* update transifex urls to explore.transifex.com ([0451b88](https://github.com/SPPRAGUE/ipfs-companion/commit/0451b88869f02d9d622e575ee86ffd04ddb6d0b5))
* update welcome page resources and links ([#1344](https://github.com/SPPRAGUE/ipfs-companion/issues/1344)) ([0d9a7ac](https://github.com/SPPRAGUE/ipfs-companion/commit/0d9a7acefd8437d236b372aafbf848d97a860521))
* upload of files bigger than 1MB ([867d49e](https://github.com/SPPRAGUE/ipfs-companion/commit/867d49e9696f94b28902592264a74105d6a30633))
...
* use long-form flags for tx pull command ([d2ac147](https://github.com/SPPRAGUE/ipfs-companion/commit/d2ac147c55851c8fe832b9982ea555bab8eaa2a9))
...
* **version:** Fixing version number ([#1297](https://github.com/SPPRAGUE/ipfs-companion/issues/1297)) ([89901ef](https://github.com/SPPRAGUE/ipfs-companion/commit/89901efb6d89dcde7b653d8eb6ee379e69c37411))
...
* yaml syntax error in tx-pull workflow ([accd741](https://github.com/SPPRAGUE/ipfs-companion/commit/accd741b9fbbd51c461340c8f08da568610fd90b))
